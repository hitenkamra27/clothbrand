    ...
    function closeAllPanels(){
      ...
      [cartPanel, wishlistPanel, accountPanel, orderHistoryPanel, accountSettingsPanel].forEach(p => p && p.classList.remove('active'));
      const mobileNav = document.getElementById('mobileNavPanel');
    ...
    function renderCart(){
      ...
      const progressPct = Math.min(100, (subtotal / freeShipThreshold()) * 100);
